#include "drako/io/input_output_file_stream.hpp"
...
namespace drako::io
{
    using _this = input_output_file_stream;

    constexpr _this::input_output_file_stream() noexcept
        : _handle{ INVALID_HANDLE_VALUE }
    {
    }

    constexpr _this::input_output_file_stream(native_handle_type handle) noexcept
        : _handle{ handle }
    {
    }

    _this::input_output_file_stream(const path_type& file, creation c = creation::if_needed)
    {
    ...
    _this::input_output_file_stream(_this&& other) noexcept
    ...
    _this::~input_output_file_stream() noexcept
    {
        if (_handle != INVALID_HANDLE_VALUE)
