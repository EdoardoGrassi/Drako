...
namespace drako
{
    ...
    {
    public:
        struct allocate_exact_size_tag
        {
            constexpr explicit allocate_exact_size_tag() = default;
        };
        struct align_cache_line_tag
        {
            constexpr explicit align_cache_line_tag() = default;
        };
        ...
        DRAKO_NODISCARD DRAKO_ALLOCATOR constexpr T* raw_data() noexcept { return m_data_ptr; }
